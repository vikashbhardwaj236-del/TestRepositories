  ...
  // find whether sheets exists	
	...
	// returns the data from a cell
		public void Hidesheet(String sheetName){
			try{
				int index = workbook.getSheetIndex(sheetName);
				//Workbook.setSheetVisibility(2);
				workbook.setSheetHidden(0,0 );
				//workbook.setSheetHidden(2, true);
				//workbook.setSheetHidden(0, HSSFWorkbook.SHEET_STATE_VERY_HIDDEN);
				//workbook.getSheetAt(0).protectSheet(sheetName);
			//	workbook.setSheetVisibility(0, SheetVisibility.VERY_HIDDEN); 
	...
	public static void main(String arg[]) throws IOException{
		...
		ExcelUtilities datatable = null;
		

			 datatable = new ExcelUtilities("H:\\Student_Selenium_Workspaces\\Framework_Weekend\\src\\Framework_XL_Files\\Controller.xlsx");
