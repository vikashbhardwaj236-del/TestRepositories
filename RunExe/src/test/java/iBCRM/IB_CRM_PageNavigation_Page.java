...
public class IB_CRM_PageNavigation_Page extends baseLib.BaseLibrary {
	...
	public WebElement Btn_ProcessVC;
	...
	public void IB_CRM_Page_Title() {
		try {
			...
			ApplicationUtilities.Fun_FailScreenshot(driver, "IB_CRM_Isue");
