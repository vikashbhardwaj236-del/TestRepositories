...
import in.dishtv.IB_CRM.IB_CRM_PageNavigation_Page;
 ...
 *
 */
public class D2h_Installation_Version_Page extends BaseLibrary {
	...
	String Installation_sheet = "D2h_EZ_Login_Data_Install";
	...
	public D2h_Installation_Version_Page() {
		super();
	...
	public void mousehover() {
		try {
			/*
			 * Thread.sleep(3000); Brand_Selection();
			 * driver.get("http://10.65.10.47:12345/activation/Installation/newrequest");
			 * Thread.sleep(3000); //Menu_Navigation(); Thread.sleep(3000);
			 */
		...
		try {
			...
			for (int i = 2; i <= rws; i++) {
				...
				if (strrun.toUpperCase().equalsIgnoreCase("Yes")) {
					...
					// ApplicationUtilities.dropdownValue(Langueddp, "Hindi");
	...
	public void Offer_Name(int i) {
		try {
			Ddl_Offer.click();
			Thread.sleep(3000);
			String Offer = xls.getCellData(Installation_sheet, "Offer Name", i);
			new Select(Ddl_Offer).selectByVisibleText(Offer);			
			Thread.sleep(3000);
		} catch (Exception ex) {
			try {
	...
	public void Language_Name(int i) {
		try {
			...
			String Offer = xls.getCellData(Installation_sheet, 11, i);
			new Select(Ddl_Language).selectByVisibleText(Offer);	
			Thread.sleep(6000);
			ApplicationUtilities.DynamicWait(driver, strLoader);
		} catch (Exception ex) {
			try {
	...
	/*public void offer(int i) {
		try {
			...
			// new Select(Ddl_Offer).selectByVisibleText(xls.getCellData(Installation_sheet,
			// "Offer Name", i));
			// Ddl_Offer.click();
			// Ddl_Language.click();
	...
	public void Validate_Installation(int i) {
		try {
			...
			System.out.println("Required Kitty Amount - " + iFkittyAmount);
			String strtkn = Integer.toString(iredkitty);
			xls.setCellData(Installation_sheet, "Kitty Amount", i, strtkn);
			if (ikitty > iredkitty) {
				ApplicationUtilities.Fun_PassScreenshot(driver, "Installation before Save");
	...
	public void filllocality(int i) {
		try {
			...
			/*
			 * String strLocality = Ddl_Locality.getText(); if
			 * (strLocality.contains("Not Aware")) {
			 * System.out.println("Area/Locality- Not Available !"); } else {
			 * ApplicationUtilities.dropdownTextContains(Ddl_Locality,
			 * xls.getCellData(Installation_sheet, "Arealocality", i));
			 * ApplicationUtilities.DynamicWait(driver, strLoader); Thread.sleep(4000); }
			 */
		} catch (Exception ex) {
	...
	public void eaypay(int i) {
		try {
			...
			driver.findElement(By.xpath("//*[@id=\"txtSecond\"]")).clear();
			driver.findElement(By.xpath("//*[@id=\"txtSecond\"]")).sendKeys("dish@123");
			driver.findElement(By.xpath("//*[@id=\"btnRecharge\"]")).click();
			Thread.sleep(5000);
			strerror = driver.findElement(By.xpath("//*[@id=\"divKittyRechargeBody\"]/div")).getText();
			System.out.println(strerror);
			driver.findElement(By.xpath("//*[@id=\"spnSuccess\"]/center/input")).click();
			Thread.sleep(5000);
			driver.findElement(By.xpath("//*[@id=\"divSummary\"]/div[1]/i")).click();
			Thread.sleep(5000);
			driver.findElement(By.xpath("//*[@id=\"btnSaveInstRequest\"]")).click();
			Thread.sleep(5000);
			Savetoken(i);
