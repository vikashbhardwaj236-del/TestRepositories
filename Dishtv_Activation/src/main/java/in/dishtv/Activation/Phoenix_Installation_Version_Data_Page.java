 ...
 *
 */
public class Phoenix_Installation_Version_Data_Page extends BaseLibrary {
	...
	public Phoenix_Installation_Version_Data_Page() {
		super();
	...
	public void offer(int i)
	{
		try
		{
			...
			Thread.sleep(3000);
			new Select(Ddl_Offer).selectByVisibleText(xls.getCellData(Installation_sheet, "Offer Name", i));
			Ddl_Offer.click();
			Ddl_Language.click();
