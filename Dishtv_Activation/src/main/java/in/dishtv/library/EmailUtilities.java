 ...
 * 
 * //public static void main(String[] args) { public void Send_email() {
 * 
 ...
 * 
 * return new PasswordAuthentication("rohitkumar14031981@gmail.com",
 * "Dishtv@123");
 * 
 * }
 * 
 ...
 * InternetAddress("vivek.kumar4@dishd2h.com"));
 * 
 * // Set the recipient address
 * 
 * message.setRecipients(Message.RecipientType.TO,InternetAddress.parse(
 * "vivek.kumar4@dishd2h.com"));
 * message.setRecipients(Message.RecipientType.CC,InternetAddress.parse(
 * "santosh.bora@dishd2h.com"));
 * 
 * // Add the subject link
 * message.setSubject("Easy pay (Dealer module) Automation test Result");
 * 
 * // Create object to add multimedia type content BodyPart messageBodyPart1 =
 * new MimeBodyPart();
 * 
 * // Set the body of email String Strmmg="Hello All,\r\n" + "\r\n" +
 * "Automation Suite has Run for easy pay (Dealer module). \r\n" +
 * "Please find attachment. \r\n" + "\r\n" + "Thanks & Regards,\r\n" +
 * "DishTV India\r\n" + ""; messageBodyPart1.setText(Strmmg);
 * 
 ...
 * "D:\\Automation\\DishTV\\screenshots\\Automation_Log.txt"; //String filename2
 * = "D:\\Automation\\DishTV\\test-output\\emailable-report.html";
 * 
 * // Create data source and pass the filename DataSource source = new
 * FileDataSource(filename); //DataSource source2 = new
 * FileDataSource(filename2);
 * 
 * // set the handler messageBodyPart2.setDataHandler(new DataHandler(source));
