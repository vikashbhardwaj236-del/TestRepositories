 ...
 *
 */
public class Phoenix_Installation_Version_Test extends BaseLibrary {

	Phoenix_Installation_Version_Page comman_obj = new Phoenix_Installation_Version_Page();
	...
	public void check_title() {
		try {
			...
			Phoenix_Installation_Version_Page obj = new Phoenix_Installation_Version_Page();
			obj.check_title();
