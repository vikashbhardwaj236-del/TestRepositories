 ...
 * 
 * public class IB_Prospective_Token_D2h_Test extends BaseLibrary {
 * IB_Prospective_Token_D2h_Page tempdeact = new
 * IB_Prospective_Token_D2h_Page(); String Actual_Title;
 * 
 * // verify Title of the CRM home page
 * 
 * @Test(priority = 1, enabled = true) public void IB_CRM_Page_Navigation() {
 * try { IB_Prospective_Token_D2h_Page IB_Prospective = new
 * IB_Prospective_Token_D2h_Page(); IB_Prospective.Pagenavigation(); } catch
 * (Exception e) { System.out.println(e.getMessage());
 * Reporter.log(e.getLocalizedMessage(), true); } } // verify propsective page
 * is opening
 * 
 * @Test(priority = 2, enabled = true) public void
 * IB_Open_propsective_Tokenpage() { try { IB_Prospective_Token_D2h_Page
 * IB_Prospective = new IB_Prospective_Token_D2h_Page();
 ...
 * propsective_Tokenpage_Scenario() { try { IB_Prospective_Token_D2h_Page
 * IB_Prospective = new IB_Prospective_Token_D2h_Page();
