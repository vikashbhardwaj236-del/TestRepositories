...
import in.dishtv.library.PropertiesLib_D2h;

public class IBloginlogout_test extends BaseLibrary
{
	in.dishtv.IB_CRM.IBloginlogout_page login;
	
	String usertype=PropertiesLib_D2h.getPropertyValue("usertypecrm");
	String userid=PropertiesLib_D2h.getPropertyValue("useridcrm");
	String password=PropertiesLib_D2h.getPropertyValue("passwordcrm");
	String urlIBinstallation=PropertiesLib_D2h.getPropertyValue("urlcrm");
